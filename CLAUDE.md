# CLAUDE.md — Servfixy Collections App

## Project
Standalone collections workflow app. Requires Texas surety bond (OCCC) before external use. Twilio A2P 10DLC campaign pending carrier approval. Part of the Servfixy platform for multifamily residential communities in Sun Belt markets.
